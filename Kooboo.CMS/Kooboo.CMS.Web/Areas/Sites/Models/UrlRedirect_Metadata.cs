...
namespace Kooboo.CMS.Web.Areas.Sites.Models
{
    ...
    public class UrlRedirect_Metadata
    {
        ...
        [GridColumn(Order = 2, HeaderText = "Input Domain", GridColumnType = typeof(SortableGridColumn))]
        [UIHint("DropDownList")]
        [DataSource(typeof(SiteDomainsDataSource))]
        [Display(Name = "Input Domain")]
        public string InputHost { get; set; }

        [GridColumn(Order = 3, HeaderText = "Output URL/Pattern", GridColumnType = typeof(SortableGridColumn))]
        [Required(ErrorMessage = "Required")]
        ...
        [GridColumn(Order = 4, HeaderText = "Output Domain", GridColumnType = typeof(SortableGridColumn))]
        [UIHint("DropDownList")]
        [DataSource(typeof(SiteDomainsDataSource))]
